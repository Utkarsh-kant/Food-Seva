...
public final class HelpActivityBinding implements ViewBinding {
  ...
  private HelpActivityBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnReport) {
  ...
  public static HelpActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HelpActivityBinding((LinearLayout) rootView, btnReport);
    }
